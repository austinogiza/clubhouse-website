...
const Press = () => {
   ...
   <Link  className='flex flex-row  items-center h-12  border-b border-1 justify-start w-full' to='/'><Hand className=' w-8 h-8'><img src={image} alt="" /></Hand><h3 className=" font-semibold  text-sm my-1 mx-1.5">Clubhouse</h3></Link></Header>
    ...
    <Platformlink href="#" target="_blank" rel="noopener noreferrer" className=" text-blue-700 ">press@clubhouse.com</Platformlink></h1>
          ...
          <Hand className=' w-60 h-20 '><img  className='w-full h-full' src="https://res.cloudinary.com/austinogiza/image/upload/v1624763331/clubhouse_logo_preview.bda8baf230c9_c6wk95.png" alt="" /></Hand>
          </Bodytext>
          <Bodytext>
